...
app_mode = st.sidebar.selectbox(" ", ["Home", "About", "Plant Disease Recognition"])
...
if (app_mode=="Home"):
    ...
    ### Get Started
    Click on the **Plant Disease Recognition** page in the sidebar to upload an image and experience the power of our Plant Disease Recognition System!
    """
    )
